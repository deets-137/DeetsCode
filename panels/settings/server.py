"""settings panel — bento of model + customization.
...
Phase 4.5 design note: was originally specified as two panels
(settings_model + settings_custom). Kept as ONE panel because v1 regions
stack vertically and the bento needs side-by-side layout. Split when the
region model gains horizontal sub-regions, or when a `subgrid` panel-author
primitive lands.
"""
...
<div class="settings-grid">
  ...
  <section class="settings-panel" data-panel="model">
    <div class="settings-header">model</div>
    <div class="settings-inner">
      <div class="nested-panel">
        <div class="nested-header">selection</div>
  ...
  <section class="settings-panel" data-panel="customization">
